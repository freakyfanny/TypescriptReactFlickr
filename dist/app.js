...
const Gallery_1 = __webpack_require__(22);
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const Hello_1 = __webpack_require__(23);
const flickrPhotos_1 = __webpack_require__(24);
const react_redux_1 = __webpack_require__(13);
class Gallery extends React.Component {
    renderButtons() {
        let colors = ['red', 'orange', 'yellow', 'green', 'blue', 'purple', 'black', 'white'];
        return colors.map(color => {
            return React.createElement("button", { className: color });
        });
    }
    render() {
        return React.createElement("div", null, React.createElement(Hello_1.Hello, { compiler: "TypeScript", framework: "React" }), React.createElement("div", { className: "header" }, React.createElement("h1", null, this.props.welcome), React.createElement("div", { className: "search" }, React.createElement("div", { className: "search__inputs" }, React.createElement("input", { type: "text", name: "search", id: "search", placeholder: "Filter on color" })))), this.renderButtons(), React.createElement(flickrPhotos_1.FlickrPhotos, { photo: this.props.photo }));
    }
}
...
class FlickrPhotos extends React.Component {
    ...
    */
    render() {
        return React.createElement("h4", null, React.createElement("b", null, "ladida"));
        /*let photoUrl = '';
...
exports.OTHER_ACTION = 'OTHER_ACTION';
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(7);
const reducer_flickr_1 = __webpack_require__(27);
...
exports.rootReducer = redux_1.combineReducers({
    photo: reducer_flickr_1.default
});
...
const INITIAL_STATE = immutable_1.fromJS({
    photo: null
});
function FlickrReducer(state = INITIAL_STATE, action) {
    switch (action.type) {
        case index_1.GET_RECENT:
            return state.with({ photo: action.payload });
        default:
            return state;
    }
}
exports.default = FlickrReducer;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(19), __webpack_require__(57)(module)))
